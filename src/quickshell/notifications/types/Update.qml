...
Notification {
    ...
    fullBody: model && model.body !== "" ? model.body : "A new version of Aether is available."
    ...
    onCardClicked: {
        ...
        Quickshell.execDetached(["bash", Caching.aetherDir + "/scripts/qs_manager.sh", "guide"]);
        doClose();
    }
    ...
    headerArea: [
        Text {
            ...
            text: model ? (model.displayName || model.appName || "Aether Updater") : "Aether Updater"
            font.family: ThemeBackend.fontFamily
