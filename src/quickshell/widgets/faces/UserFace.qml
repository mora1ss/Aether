            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    ClickButton {
                        ...
                        onClicked: Quickshell.execDetached(["bash", "-c", Caching.aetherDir + "/scripts/qs_manager.sh toggle guide"])
                    }
                    ...
                    ClickButton {
                        ...
                        onClicked: {
                            Quickshell.execDetached(["bash", Caching.aetherDir + "/scripts/lock.sh"]);
                        }
                    }
                }
            }
                    ...
                    delegate: Rectangle {
                        ...
                        Timer {
                            ...
                            onTriggered: {
                                ...
                                let scriptPath = Caching.aetherDir + "/scripts/system/" + (cmd === "sleep" ? "suspend.sh" : cmd + ".sh");
