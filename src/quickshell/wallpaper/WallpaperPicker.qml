...
Item {
    ...
    readonly property string scriptDir: Caching.aetherDir + "/scripts/wallpaper"
    ...
    Process {
        id: monitorDetector
        running: false
        command: ["bash", Caching.aetherDir + "/scripts/monitors_detect.sh"]
    ...
    function triggerOnlineSearch() {
        ...
        Quickshell.execDetached([
            ...
            Caching.getRunDir("wallpaper"),
            Caching.logDir,
            Caching.aetherDir + "/scripts/wallpaper/ddg_search.sh"
        ]);
        view.forceActiveFocus();
    }
