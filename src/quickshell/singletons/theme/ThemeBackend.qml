...
Item {
    ...
    property string configPath: Quickshell.env("QS_COLORS_JSON") ?? "~/.local/state/aether/qs_colors.json"
    property string matugenConfigPath: (typeof Caching !== "undefined" && Caching.stateDir ? Caching.stateDir : ((Quickshell.env("HOME") ?? "") + "/.local/state/aether")) + "/qs_matugen_colors.json"
    ...
    Process {
        ...
        command: {
            let sys = Caching.aetherDir ? (Caching.aetherDir + "/assets/fonts") : "";
            let usr = Caching.stateDir ? (Caching.stateDir + "/fonts") : (Caching.home + "/.local/state/aether/fonts");
            let cacheFile = Caching.stateDir ? (Caching.stateDir + "/fonts_cache.txt") : (Caching.home + "/.local/state/aether/fonts_cache.txt");
